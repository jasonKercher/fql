...
public:
  enum { ABS = 1,
	 ...
	 ALL = 5,
	 ALLOW_CONNECTIONS = 6,
	 ALLOW_MULTIPLE_EVENT_LOSS = 7,
	 ALLOW_SINGLE_EVENT_LOSS = 8,
	 ALTER = 9,
	 AND = 10,
	 ANONYMOUS = 11,
	 ANY = 12,
	 ...
	 ASCII = 17,
	 ASYMMETRIC = 18,
	 ASYNCHRONOUS_COMMIT = 19,
	 AUTHORIZATION = 20,
	 AUTHENTICATION = 21,
	 AUTOMATED_BACKUP_PREFERENCE = 22,
	 AUTOMATIC = 23,
	 AVAILABILITY_MODE = 24,
	 BACKSLASH = 25,
	 BACKUP = 26,
	 BEFORE = 27,
	 BEGIN = 28,
	 ...
	 DISTRIBUTED = 102,
	 DOUBLE = 103,
	 DOUBLE_BACK_SLASH = 104,
	 DOUBLE_FORWARD_SLASH = 105,
	 DROP = 106,
	 DTC_SUPPORT = 107,
	 DUMP = 108,
	 ELSE = 109,
	 ...
	 FOR = 137,
	 FORCESEEK = 138,
	 FORCE_SERVICE_ALLOW_DATA_LOSS = 139,
	 FOREIGN = 140,
	 FREETEXT = 141,
	 FREETEXTTABLE = 142,
	 FROM = 143,
	 ...
	 MAXTRANSFER = 200,
	 MAXVALUE = 201,
	 MAX_DISPATCH_LATENCY = 202,
	 MAX_EVENT_SIZE = 203,
	 MAX_SIZE = 204,
	 MAX_OUTSTANDING_IO_PER_VOLUME = 205,
	 MEDIADESCRIPTION = 206,
	 MEDIANAME = 207,
	 MEMBER = 208,
	 MEMORY_PARTITION_MODE = 209,
	 MERGE = 210,
	 MESSAGE_FORWARDING = 211,
	 MESSAGE_FORWARD_SIZE = 212,
	 MINVALUE = 213,
	 MIRROR = 214,
	 MONTH = 215,
	 MUST_CHANGE = 216,
	 ...
	 READ = 279,
	 READTEXT = 280,
	 READ_WRITE_FILEGROUPS = 281,
	 RECONFIGURE = 282,
	 REFERENCES = 283,
	 REGENERATE = 284,
	 RELATED_CONVERSATION = 285,
	 RELATED_CONVERSATION_GROUP = 286,
	 REPLACE = 287,
	 REPLICATION = 288,
	 REQUIRED = 289,
	 RESET = 290,
	 ...
	 SECURITYAUDIT = 320,
	 SELECT = 321,
	 SEMANTICKEYPHRASETABLE = 322,
	 SEMANTICSIMILARITYDETAILSTABLE = 323,
	 SEMANTICSIMILARITYTABLE = 324,
	 SERVER = 325,
	 SERVICE = 326,
	 SERVICE_BROKER = 327,
	 SERVICE_NAME = 328,
	 ...
	 AGGREGATE = 416,
	 ALGORITHM = 417,
	 ALLOW_ENCRYPTED_VALUE_MODIFICATIONS = 418,
	 ALLOW_SNAPSHOT_ISOLATION = 419,
	 ALLOWED = 420,
	 ANSI_NULL_DEFAULT = 421,
	 ANSI_NULLS = 422,
	 ANSI_PADDING = 423,
	 ANSI_WARNINGS = 424,
	 APPLICATION_LOG = 425,
	 ...
	 AUTO_CLEANUP = 432,
	 AUTO_CLOSE = 433,
	 AUTO_CREATE_STATISTICS = 434,
	 AUTO_SHRINK = 435,
	 AUTO_UPDATE_STATISTICS = 436,
	 AUTO_UPDATE_STATISTICS_ASYNC = 437,
	 AVAILABILITY = 438,
	 AVG = 439,
	 BACKUP_PRIORITY = 440,
	 BEGIN_DIALOG = 441,
	 ...
	 CATALOG = 453,
	 CATCH = 454,
	 CHANGE_RETENTION = 455,
	 CHANGE_TRACKING = 456,
	 CHECKSUM = 457,
	 CHECKSUM_AGG = 458,
	 CLEANUP = 459,
	 COLLECTION = 460,
	 COLUMN_MASTER_KEY = 461,
	 COMMITTED = 462,
	 COMPATIBILITY_LEVEL = 463,
	 CONCAT = 464,
	 CONCAT_NULL_YIELDS_NULL = 465,
	 CONTENT = 466,
	 CONTROL = 467,
	 COOKIE = 468,
	 COUNT = 469,
	 ...
	 CPU = 472,
	 CREATE_NEW = 473,
	 CREATION_DISPOSITION = 474,
	 CREDENTIAL = 475,
	 CRYPTOGRAPHIC = 476,
	 CURSOR_CLOSE_ON_COMMIT = 477,
	 CURSOR_DEFAULT = 478,
	 DATA = 479,
	 DATALENGTH = 480,
	 DATE_CORRELATION_OPTIMIZATION = 481,
	 DATEADD = 482,
	 DATEDIFF = 483,
	 DATENAME = 484,
	 DATEPART = 485,
	 ...
	 DB_FAILOVER = 489,
	 DECRYPTION = 490,
	 DEFAULT_DOUBLE_QUOTE = 491,
	 DEFAULT_FULLTEXT_LANGUAGE = 492,
	 DEFAULT_LANGUAGE = 493,
	 DELAY = 494,
	 DELAYED_DURABILITY = 495,
	 DELETED = 496,
	 DENSE_RANK = 497,
	 DEPENDENTS = 498,
	 DES = 499,
	 ...
	 ENCRYPTION = 517,
	 ENDPOINT_URL = 518,
	 ERROR_BROKER_CONVERSATIONS = 519,
	 EXCLUSIVE = 520,
	 EXECUTABLE = 521,
	 EXIST = 522,
	 EXPAND = 523,
	 ...
	 FOLLOWING = 539,
	 FORCE = 540,
	 FORCE_FAILOVER_ALLOW_DATA_LOSS = 541,
	 FORCED = 542,
	 FORMAT = 543,
	 FORWARD_ONLY = 544,
	 FULLSCAN = 545,
	 ...
	 GLOBAL = 550,
	 GO = 551,
	 GROUP_MAX_REQUESTS = 552,
	 GROUPING = 553,
	 GROUPING_ID = 554,
	 HADR = 555,
	 HASH = 556,
	 HEALTH_CHECK_TIMEOUT = 557,
	 HIGH = 558,
	 HONOR_BROKER_PRIORITY = 559,
	 HOURS = 560,
	 IDENTITY_VALUE = 561,
	 IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX = 562,
	 IMMEDIATE = 563,
	 IMPERSONATE = 564,
	 IMPORTANCE = 565,
	 INCLUDE_NULL_VALUES = 566,
	 INCREMENTAL = 567,
	 INITIATOR = 568,
	 INPUT = 569,
	 INSENSITIVE = 570,
	 ...
	 MAX_DOP = 604,
	 MAX_FILES = 605,
	 MAX_IOPS_PER_VOLUME = 606,
	 MAX_MEMORY_PERCENT = 607,
	 MAX_PROCESSES = 608,
	 MAX_QUEUE_READERS = 609,
	 MAX_ROLLOVER_FILES = 610,
	 MAXDOP = 611,
	 MAXRECURSION = 612,
	 MAXSIZE = 613,
	 MB = 614,
	 MEDIUM = 615,
	 MEMORY_OPTIMIZED_DATA = 616,
	 MESSAGE = 617,
	 MIN = 618,
	 MIN_ACTIVE_ROWVERSION = 619,
	 MIN_CPU_PERCENT = 620,
	 MIN_IOPS_PER_VOLUME = 621,
	 MIN_MEMORY_PERCENT = 622,
	 MINUTES = 623,
	 MIRROR_ADDRESS = 624,
	 MIXED_PAGE_ALLOCATION = 625,
	 MODE = 626,
	 MODIFY = 627,
	 MOVE = 628,
	 MULTI_USER = 629,
	 ...
	 OWNER = 662,
	 PAGE_VERIFY = 663,
	 PARAMETERIZATION = 664,
	 PARTITION = 665,
	 PARTITIONS = 666,
	 PARTNER = 667,
	 PATH = 668,
	 POISON_MESSAGE_HANDLING = 669,
	 POOL = 670,
	 PORT = 671,
	 PRECEDING = 672,
	 PRIMARY_ROLE = 673,
	 ...
	 PROPERTY = 681,
	 PROVIDER = 682,
	 PROVIDER_KEY_NAME = 683,
	 QUERY = 684,
	 QUEUE = 685,
	 QUEUE_DELAY = 686,
	 QUOTED_IDENTIFIER = 687,
	 RANGE = 688,
	 RANK = 689,
	 RC2 = 690,
	 RC4 = 691,
	 RC4_128 = 692,
	 READ_COMMITTED_SNAPSHOT = 693,
	 READ_ONLY = 694,
	 READ_ONLY_ROUTING_LIST = 695,
	 READ_WRITE = 696,
	 READONLY = 697,
	 REBUILD = 698,
	 RECEIVE = 699,
	 RECOMPILE = 700,
	 RECOVERY = 701,
	 RECURSIVE_TRIGGERS = 702,
	 RELATIVE = 703,
	 REMOTE = 704,
	 REMOTE_SERVICE_NAME = 705,
	 REMOVE = 706,
	 REORGANIZE = 707,
	 REPEATABLE = 708,
	 REPLICA = 709,
	 REQUEST_MAX_CPU_TIME_SEC = 710,
	 REQUEST_MAX_MEMORY_GRANT_PERCENT = 711,
	 REQUEST_MEMORY_GRANT_TIMEOUT_SEC = 712,
	 REQUIRED_SYNCHRONIZED_SECONDARIES_TO_COMMIT = 713,
	 RESERVE_DISK_SPACE = 714,
	 RESOURCE = 715,
	 RESOURCE_MANAGER_LOCATION = 716,
	 RESTRICTED_USER = 717,
	 RETENTION = 718,
	 ROBUST = 719,
	 ROOT = 720,
	 ...
	 SUSPEND = 772,
	 SYMMETRIC = 773,
	 SYNCHRONOUS_COMMIT = 774,
	 SYNONYM = 775,
	 SYSTEM = 776,
	 TAKE = 777,
	 TARGET_RECOVERY_TIME = 778,
	 TB = 779,
	 TEXTIMAGE_ON = 780,
	 THROW = 781,
	 TIES = 782,
	 ...
	 TIMER = 785,
	 TINYINT = 786,
	 TORN_PAGE_DETECTION = 787,
	 TRANSFORM_NOISE_WORDS = 788,
	 TRIPLE_DES = 789,
	 TRIPLE_DES_3KEY = 790,
	 TRUSTWORTHY = 791,
	 TRY = 792,
	 TSQL = 793,
	 TWO_DIGIT_YEAR_CUTOFF = 794,
	 TYPE = 795,
	 TYPE_WARNING = 796,
	 UNBOUNDED = 797,
	 UNCOMMITTED = 798,
	 ...
	 DOUBLE_QUOTE_ID = 824,
	 SINGLE_QUOTE = 825,
	 SQUARE_BRACKET_ID = 826,
	 LOCAL_ID = 827,
	 DECIMAL = 828,
	 ID = 829,
	 QUOTED_URL = 830,
	 QUOTED_HOST_AND_PORT = 831,
	 STRING = 832,
	 BINARY = 833,
	 FLOAT = 834,
	 REAL = 835,
